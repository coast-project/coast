...
public:
	...
	static void SortByKeyInArray(const String &sortFieldName, Anything &toSort, EMode mode = asc,
								 bool sortCritIsNumber = false);
};
...
namespace AnyExtensions {
	...
	template <template <class> class ComparerPolicy /*= KeyComparer*/, template <class> class SortPolicy /*= MergeSortAlgo*/
			  >
	struct Sorter {

...
public:
	...
	PipeExecutor(const String &cmd, Anything env, const char *wd = ".", long lExecTimeout = 1000L,
				 bool bOpenStreamForStderr = false);
...
protected:
	...
	PipeExecutor() : fPipe(0), fChildPid(-1), fStderr(0), fTimeout(0) {}  // empty default ctor for testing purposes only
	//--- subclass api
	//! do the real work

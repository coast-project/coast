...
void URLUtilsTest::CheckUrlPathContainsUnsafeCharsTest() {
	...
	bool careAboutExtendedAscii = true, ignoreExtendedAscii = false;
	{
		...
		char asciiChars[] = {x00};
		assertEqual(true,
					coast::urlutils::CheckUrlPathContainsUnsafeChars(srcChars, unsafeChars, asciiChars, ignoreExtendedAscii));
	}
	{
		char srcChars[] = {'a', 'b', 'c', 'd', xF6, 'e', 'f', 'g', x00};
		char unsafeChars[] = {xF6, x00};
		char asciiChars[] = {x00};
		assertEqual(
			true, coast::urlutils::CheckUrlPathContainsUnsafeChars(srcChars, unsafeChars, asciiChars, careAboutExtendedAscii));
	}
	{
	...
	}
	{
		...
		assertEqual(
			false, coast::urlutils::CheckUrlPathContainsUnsafeChars(srcChars, unsafeChars, asciiChars, careAboutExtendedAscii));
	}
	{
		char srcChars[] = {'a', 'b', 'c', 'd', xF6, 'e', 'f', 'g', x00};
		char unsafeChars[] = {xF6, x00};
...
void URLUtilsTest::urlDecodeTest() {
...

	{
		...
		Request =
			"%u0030%u0031%u0032%u0033%u0034%u0035%u0036%u0037%u0038%u0039%u0041%u0042%u0043%u0044%u0045%u0046%u0061%u0062%"
			"u0063%"
			"u0064%u0065%u0066";
		Answer = coast::urlutils::urlDecode(Request);
		assertCharPtrEqual("0123456789ABCDEFabcdef", Answer);

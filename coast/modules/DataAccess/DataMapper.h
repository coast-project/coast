...
public:
	FixedSizeMapper(const char *name) : EagerParameterMapper(name) {}

	/*! @copydoc IFAObject::Clone(Allocator *) const */
	IFAObject *Clone(Allocator *a) const { return new (a) FixedSizeMapper(fName); }
...
public:
	UpperCaseMapper(const char *name) : EagerParameterMapper(name) {}

	/*! @copydoc IFAObject::Clone(Allocator *) const */
	IFAObject *Clone(Allocator *a) const { return new (a) UpperCaseMapper(fName); }
...
public:
	LookupMapper(const char *name) : EagerParameterMapper(name) {}

	/*! @copydoc IFAObject::Clone(Allocator *) const */
	IFAObject *Clone(Allocator *a) const { return new (a) LookupMapper(fName); }
...
public:
	RendererMapper(const char *name) : EagerParameterMapper(name) {}

	/*! @copydoc IFAObject::Clone(Allocator *) const */
	IFAObject *Clone(Allocator *a) const { return new (a) RendererMapper(fName); }

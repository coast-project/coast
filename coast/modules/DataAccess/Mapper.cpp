...
ParameterMapper::ParameterMapper(const char *name) : HierarchConfNamed(name) {}
...
bool ParameterMapper::interpretMapperScriptEntry(const char *key, Anything &value, Context &ctx, ROAnything script,
...
bool ParameterMapper::interpretMapperScript(const char *key, Anything &value, Context &ctx, ROAnything script) {
	StartTrace1(ParameterMapper.interpretMapperScript,
				"( \"" << NotNull(key) << "\" , ValueType &value, Context &ctx, ROAnything script)");
...
bool ParameterMapper::DoGetAnyWithSlotname(const char *key, Anything &value, Context &ctx, ROAnything roaScript,
										   const char *slotname) {
...
bool ParameterMapper::interpretMapperScriptEntry(const char *key, std::ostream &os, Context &ctx, ROAnything script,
												 String const &slotname) {
	StartTrace1(ParameterMapper.interpretMapperScriptEntry,
...
bool ParameterMapper::DoGetStreamWithSlotname(const char *key, std::ostream &os, Context &ctx, ROAnything roaScript,
											  const char *slotname) {
...
ResultMapper::ResultMapper(const char *name) : HierarchConfNamed(name) {}
...
bool ResultMapper::DoPutAnyWithSlotname(const char *key, Anything &value, Context &ctx, ROAnything roaScript,
										const char *slotname) {
...
bool ResultMapper::DoPutStreamWithSlotname(const char *key, std::istream &is, Context &ctx, ROAnything roaScript,
										   const char *slotname) {

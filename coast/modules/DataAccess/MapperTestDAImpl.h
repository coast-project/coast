...
/*! This data access implementation uses ParameterMapper.Get() and ResultMapper.Put() of a specified type to put through the
requested values.
...
public:
	...
	MapperTestDAImpl(const char *name) : DataAccessImpl(name) {}

	/*! @copydoc IFAObject::Clone(Allocator *) const */
	IFAObject *Clone(Allocator *a) const { return new (a) MapperTestDAImpl(fName); }

...
To further process the converted Anything one can provide a MapperScript which extracts and stores either parts of the converted
Anything or the whole Anything.
\par Configuration
\code
{
  /key {
...
public:
	...
	StreamToAnythingMapper(const char *name) : AnythingLookupPathResultMapper(name) {}

	/*! @copydoc IFAObject::Clone(Allocator *) const */
	IFAObject *Clone(Allocator *a) const { return new (a) StreamToAnythingMapper(fName); }
...
public:
	/*! @copydoc RegisterableObject::RegisterableObject(const char *) */
	AnythingToStreamMapper(const char *name) : ParameterMapper(name) {}

	/*! @copydoc IFAObject::Clone(Allocator *) const */
	IFAObject *Clone(Allocator *a) const { return new (a) AnythingToStreamMapper(fName); }

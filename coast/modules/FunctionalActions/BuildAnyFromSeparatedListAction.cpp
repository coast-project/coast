...
bool BuildAnyFromSeparatedListAction::DoExecAction(String &transitionToken, Context &ctx, const ROAnything &config) {
	...
	if (ReadConfig(text, recordSeparator, fieldSeparator, bFieldSep, useSlotName, bUseSlot, lHeaderRows, sHeaderSeparator, ctx,
				   config)) {
		Anything tmp;
...
bool BuildAnyFromSeparatedListAction::ReadConfig(String &text, String &recordSeparator, String &fieldSeparator, bool &bFieldSep,
												 String &useSlotName, bool &bUseSlot, long &lHeaderRows,
												 String &sHeaderSeparator, Context &ctx, const ROAnything &config) {
...
bool BuildAnyFromSeparatedListAction::ReadValue(String &retValue, const ROAnything &store, const String &location,
												Context &ctx) {
...
bool BuildAnyFromSeparatedListAction::DoBuildHeader(Anything &anyHeaderTok, Anything &anyHeader, String &sHeaderSeparator,
													bool &bBuildHeader) {
...
bool BuildAnyFromSeparatedListAction::BuildAnything(String &text, String &recordSeparator, String &fieldSeparator,
													bool &bFieldSep, bool &bUseSlot, long &lHeaderRows,

...
public:
	BuildAnyFromSeparatedListAction(const char *name) : Action(name) {}
...
private:
	...
	bool ReadConfig(String &text, String &recordSeparator, String &fieldSeparator, bool &bFieldSep, String &useSlotName,
					bool &bUseSlot, long &lHeaderRows, String &sHeaderSeparator, Context &ctx, const ROAnything &config);
	...
	bool BuildAnything(String &text, String &recordSeparator, String &fieldSeparator, bool &bFieldSep, bool &bUseSlot,
					   long &lHeaderRows, String &sHeaderSeparator, Anything &tmp);
};

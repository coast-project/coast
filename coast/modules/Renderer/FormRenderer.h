...
The actual List item data can be accessed under SelectBoxOption, the Index SelectBoxOptionIndex and the slotname
SelectBoxOptionSlotname Use this if you dont want to build up an extra list for the selectbox renderer
*/
...
protected:
	...
	virtual void RenderEntry(std::ostream &reply, Context &ctx, const ROAnything &config, const ROAnything &entryRendererConfig,
	...
	/*! renders a entry header using the given configuration
	  ...
	  \param listItem current list item data as shortcut (instead of using ctx.Lookup )
	  \param anyRenderState anything to carry information between different calls */
	virtual void RenderEntryHeader(std::ostream &reply, Context &ctx, const ROAnything &entryHeader, const ROAnything &listItem,
	...
	/*! renders a entry footer using the given configuration
	  ...
	  \param listItem current list item data as shortcut (instead of using ctx.Lookup )
	  \param anyRenderState anything to carry information between different calls */
	virtual void RenderEntryFooter(std::ostream &reply, Context &ctx, const ROAnything &entryFooter, const ROAnything &listItem,
								   Anything &anyRenderState);

	virtual void RenderValue(std::ostream &reply, Context &c, const ROAnything &config, const ROAnything &valueConfig,
							 const ROAnything &listItem);
	virtual void RenderSelected(std::ostream &reply, Context &c, const ROAnything &config, const ROAnything &selectedConfig,
								const ROAnything &listItem);

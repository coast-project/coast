...
public:
	StringTokenizeRenderer(const char *name) : Renderer(name) {}
...
protected:
	...
	void BuildOutputString(Context &ctx, const ROAnything &config, String &strOut, Anything &anyTokensToOutput,
						   Anything &anyTokens);
};

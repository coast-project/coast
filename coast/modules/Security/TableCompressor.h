...
public:
	...
	IFAObject *Clone(Allocator *a) const { return new (a) TableCompressor(fName); }
	...
	//! the values of scrambledText are converted by Uri2ValMap if they are values of ValMapTags e.g. Rolenames, Pagenames,
	//! Actionnames

...
void MD5Test::hashCheck() {
	...
	assertEqual("d174ab98d277d9f5a5611c2c9f419d9f",
				hexhash(md5, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"));
	assertEqual("57edf4a22be3c955ac49da2e2107b67a",
				hexhash(md5, "12345678901234567890123456789012345678901234567890123456789012345678901234567890"));

...
/*!
Use a specific Mapper to implement a protocol. For example you can use a AnythingToStreamMapper or a StreamToAnythingMapper to
use an Anything as transport packet
\par Configuration
\code
{
...
protected:
	...
	virtual bool SendInput(std::iostream *Ios, Socket *s, long lCheckReadyTimeout, long lSocketStreamTimeout, Context &context,
						   ParameterMapper *, ResultMapper *);

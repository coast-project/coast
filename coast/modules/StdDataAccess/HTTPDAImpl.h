...
public:
	HTTPDAImpl(const char *name) : DataAccessImpl(name) {}

	/*! @copydoc IFAObject::Clone(Allocator *) const */
	IFAObject *Clone(Allocator *a) const { return new (a) HTTPDAImpl(fName); }
...
#if defined(RECORD)
	//! simulates a connection to a server, outgoing request is tested, incoming reply is assembled and sent, used when testing
	//! ONLY \param context the context for this call \param in input Mapper \param out output Mapper

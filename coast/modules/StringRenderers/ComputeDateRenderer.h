...
class TimeStamp;
//---- ComputeDateRenderer ----------------------------------------------------------
//! Converts the given Date/Time according to the specified format into a bunch of seconds (unix-time, seconds since 1. Jan.
//! 1970 00:00)
/*!
\par Configuration
\code
{
  ...
  /InputFormat	Rendererspec		optional, default: dd.mm.YYYY (00:00:00)
					  ...
					  * YY 	for year without century as decimal number, assume values above or equal 70 to be in century 19,
					  *		others in century 20

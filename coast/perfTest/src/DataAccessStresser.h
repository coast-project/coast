...
public:
	DataAccessStresser(const char *DataAccessStresserName) : Stresser(DataAccessStresserName) {}
	...
	IFAObject *Clone(Allocator *a) const { return new (a) DataAccessStresser(fName); }
};

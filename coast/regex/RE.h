...
public:
	...
	void SetMatchFlags(eMatchFlags matchFlags) { this->fMatchFlags = matchFlags; }
	...
	bool IsValid() const { return fProgram.GetSize() > 0; }
	// do the matching
	...
	long GetRegisterCount() const { return fRegisters.GetSize(); }

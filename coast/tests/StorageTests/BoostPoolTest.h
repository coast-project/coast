...
#define FUNCDECLARER(TSTFUNC, NTHREADS, NSIZE) void BOOST_PP_SEQ_CAT((PoolPerfTest)(TSTFUNC)(NTHREADS)(NSIZE))();

#define FUNCDECLARERTUPLE(ARGSTUPLE)                                                         \
	FUNCDECLARER(BOOST_PP_TUPLE_ELEM(3, 0, ARGSTUPLE), BOOST_PP_TUPLE_ELEM(3, 1, ARGSTUPLE), \
				 BOOST_PP_TUPLE_ELEM(3, 2, ARGSTUPLE))

#define FUNCDECLARERMACRO(r, product) FUNCDECLARERTUPLE(BOOST_PP_SEQ_TO_TUPLE(product))

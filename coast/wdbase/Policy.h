...
public:
	...
	const char *const GetCategory() const { return fCategory; }
...
public:
	AliasInstaller(const char *category) : InstallerPolicy(category) {}
...
public:
	AliasTerminator(const char *category) : TerminationPolicy(category) {}
...
public:
	HierarchyInstaller(const char *cat) : InstallerPolicy(cat) {}

...
public:
	RenderersModule(const char *name) : WDModule(name) {}
...
//! Renderer implements a render script interpreter to generate (mostly but necessarily html) output in a flexible, configurable
//! way
class Renderer : public NotCloned {
public:
	/*! @copydoc RegisterableObject::RegisterableObject(const char *) */
	Renderer(const char *name) : NotCloned(name) {}

...
public:
	...
	AcceptorFactory(const char *AcceptorFactoryName) : HierarchConfNamed(AcceptorFactoryName) {}
	//! registry interface
	RegCacheDef(AcceptorFactory);  // FindAcceptorFactory()
	/*! @copydoc IFAObject::Clone(Allocator *) const */
	IFAObject *Clone(Allocator *a) const { return new (a) AcceptorFactory(fName); }
...
public:
	...
	ListenerThread(AcceptorCallBack *ac) : Thread("ListenerThread"), fCallBack(ac), fAcceptor(0) {}

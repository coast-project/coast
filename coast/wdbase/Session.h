...
public:
	...
	virtual bool IsLockedByMe() { return fMutex.IsLockedByMe(); }
	...
	enum ESessionEvt { eAdded, eRemoved };
...
private:
	...
	virtual Anything &GetStore() { return GetStoreGlobal(); }
...
public:
	SessionInfo(const char *name) : Action(name) {}

...
TestSession::TestSession(const char *name, Context &ctx, SessionListManagerTest *slmt) : Session(name), fTest(slmt) {
...
TestSessionFactory::TestSessionFactory(const char *testSessionFactoryName, SessionListManagerTest *slmt)
	: SessionFactory(testSessionFactoryName), fTest(slmt) {

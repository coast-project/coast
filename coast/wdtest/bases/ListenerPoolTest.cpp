...
public:
	...
	IFAObject *Clone(Allocator *a) const { return new (a) FakeAcceptorFactory(fName); }

	Acceptor *MakeAcceptor(AcceptorCallBack *ac) { return 0; }
...
//---- ListenerPoolTest ----------------------------------------------------------------
ListenerPoolTest::ListenerPoolTest(TString tname) : TestCaseType(tname) {

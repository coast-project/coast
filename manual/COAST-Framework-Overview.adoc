...
:title-logo-image: image:coast.png[pdfwidth="40%"]
//:toc: macro
//:doctype: book
//:media: screen
...
|image:PageTransition.svg[title="Page transition", alt="Page transition",id=pagetransition,width="90%",pdfwidth="90%",align=center]
|====
...
plantuml::PagePostprocessing.plantuml[format=svg, title="Page postprocessing", width="90%",pdfwidth="80%",align=center]

ifdef::slideoutput[<<<]
==== Page transition: Preprocess / Render

plantuml::PagePreprocessing.plantuml[format=svg, title="Page preprocessing", width="90%",pdfwidth="80%",align=center]
